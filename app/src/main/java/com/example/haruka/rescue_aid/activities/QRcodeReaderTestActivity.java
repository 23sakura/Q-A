...
public class QRcodeReaderTestActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.AutoFocusCallback, Camera.PreviewCallback {
    ...
    private void setPreviewSize() {
        ...
        Log.d("Screen size", "width, height = " + Integer.toString(screenWidth) + ", " + Integer.toString(screenHeight));
